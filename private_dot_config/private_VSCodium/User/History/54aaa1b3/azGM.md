...
| Where  | Command                                                                                 |
| ------ | :-------------------------------------------------------------------------------------- |
| Fedora | move ca.pem to ```/usr/local/share/ca-certificates/ca.crt``` <br> ```update-ca-trust``` |
| Debian | move ca.pem to ```/usr/local/share/ca-certificates/ca.crt``` <br> ```update-ca-trust``` |
