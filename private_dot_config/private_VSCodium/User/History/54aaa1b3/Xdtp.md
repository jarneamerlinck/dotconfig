...
| [Fedora](https://docs.fedoraproject.org/en-US/quick-docs/using-shared-system-certificates/) | move ca.pem to ```/usr/share/pki/ca-trust-source/anchors/ca.pem``` <br> ```update-ca-trust```       |
