...
from src.pyiotdataflow.airtable import (
    add_metadata,
    sensor,
    sensor_placement_deployment_metadata,
)
from src.pyiotdataflow.connection import dbase_engine
from src.pyiotdataflow.geoluxserver import get_geolux_data
from src.pyiotdataflow.load import exclude_duplicate, merge_ids
from src.pyiotdataflow.metadata import update_metadata
...
for sensor_id in sensor_ids:
    try:
        ...
        logger.error(f"Geolux API request error - {exc}")
